		...
		<div class="unit-20">
			<form action="api/Buscas/busca" id='menuBusca' method="post">
				...
				<ul id='places'>
					<li>
						<label for="">
							<input checked type="checkbox" name='places[Usuario]'><span>Usuários</span>
						</label>
					</li>
					<li>
						<label for="">
							<input checked type="checkbox" name='places[Curso]'><span>Cursos</span>
						</label>
					</li>
					<li>
						<label for="">
							<input checked type="checkbox" name='places[Ciclo]'><span>Ciclos de Matrícula</span>
						</label>
					</li>
					<li>
						<label for="">
							<input checked type="checkbox" name='places[Aluno]'><span>Alunos</span>
						</label>
					</li>
				</ul>
				<hr>
